...
Run next command to upload firmware to Elements: 
...
build_elements () {
	...
	# Note 4  myself: Mmmmm... seems like next statements could be erased!
	#STMCFG_FILE="stm32f4xx.cfg"
